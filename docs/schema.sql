...
create table dbo.pubacc_EC       
( 
	record_type			varchar(2)	not null,
	unique_system_identifier	numeric(9,0)	not null,
	uls_file_number			char(14)	null,
	callsign			char(10)	null,
	ecip_flag			char(1)		null,
	ecip_prong			char(1)		null,
	holding_period_begin		char(10)	null,
	holding_period_end		char(10)	null
)

go

create table dbo.pubacc_IF        
( 
	record_type			varchar(2)	not null,
	unique_system_identifier	numeric(9,0)	not null,
	uls_file_number			char(14)	null,
	item_type			varchar(10)	null,
	iorn_operation_begin_date	char(10)	null, 
	iorn_certification		char(1)		null,
	forn_deadline			char(10)	null,
	forn_operation_completed	char(10)	null, 
	forn_certification		char(1)		null
)
